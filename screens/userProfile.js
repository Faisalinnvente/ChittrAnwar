  ...
  class UserProfileScreen extends React.Component {
    ...
    getUserData() {
        var requestOptions = {
          ...
          fetch("http://192.168.100.3:3333/api/v0.0.5/user/" + this.state.userId, requestOptions)
            .then(response => {
                response.json()
                .then((userData) => {
                    this.setState({
    ...
    followUser = () => { 
        ...
        fetch("http://192.168.100.3:3333/api/v0.0.5/user/" + this.state.userId + "/follow", requestOptions)
