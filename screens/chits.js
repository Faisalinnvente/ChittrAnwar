...
class ChitsScreen extends React.Component {
    ...
    getChits() {
        var requestOptions = {
          ...
          fetch("http://192.168.100.3:3333/api/v0.0.5/chits", requestOptions)
            ...
            .then(result => {
                ...
                var requestOptions = {
                  ...
                  fetch("http://192.168.100.3:3333/api/v0.0.5/chits/3/photo", requestOptions)
    ...
    logout = () => { 
        ...
        fetch("http://192.168.100.3:3333/api/v0.0.5/logout", requestOptions)
        .then(response => {
